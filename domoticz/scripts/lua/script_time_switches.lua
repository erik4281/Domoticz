...
for i, v in pairs(otherdevices) do
	...
	if (ts == 'FanSwitch3' and otherdevices['People'] == 'On') then
		if (otherdevices[ts] == 'Off' and ((otherdevices['TemperatureLiving'] + 1) > (otherdevices['TempHumBar']:sub(1,4) + 5)) and (otherdevices['TemperatureLiving'] - 1) > 23) then
		...
		if (otherdevices[ts] == 'On' and ((otherdevices['TemperatureLiving'] + 1) < (otherdevices['TempHumBar']:sub(1,4) + 5))) then
